...
export default function UserFeedPage({
  ...
  if (isLoading) {
    return (
      <div className="h-screen snap-y snap-mandatory overflow-y-scroll pt-20">
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
  ...
  return (
    <div className="h-[100vh] snap-y snap-mandatory overflow-y-scroll">
      ...
      {issues?.map((issue) => (
        <div
          key={issue.id}
          className="h-[100vh] snap-start pt-20 pb-6 px-3 flex items-center"
        >
      ...
      {/* Empty State */}
      {!issues?.length && (
        <div className="h-[100vh] snap-start pt-20 pb-6 flex items-center justify-center px-4">
