...
export function CreatePost() {
  ...
  const rtClientRef = useRef<ReturnType<
    typeof createGeminiRealtimeClient
  > | null>(null);
  ...
  const handleSubmit = async () => {
    ...
    if (!location.trim()) {
      toast({
        ...
        description: "Please enter the issue location.",
        variant: "destructive",
      });
      return;
    }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Task 1: Removed profile icon - content now starts directly */}
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Type location: area, landmark, street name..."
              required
        ...
        <div className="flex flex-col items-center pt-4 border-t border-gray-200 space-y-4">
          {!analysis ? (
            <div className="flex flex-col items-center space-y-2">
              ...
              {/* Task 7: Helper text under AI button */}
              <p className="text-xs text-gray-400 text-center">
                AI will categorize and assess severity of the issue
              </p>
            </div>
          ) : (
            <Button
            ...
            >
              {createIssueMutation.isPending ? (
                ...
                <>
                  ...
                  {/* Task 8: Updated submit button text */}
                  Report the issue
                </>
              )}
            </Button>
